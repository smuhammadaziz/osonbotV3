...
from keyboards.inline.data import SirdaryoData
...
@sirdaryo_yer_router.callback_query(SirdaryoData.filter(F.word=="sirdaryoyer"))
async def first(callback_query: CallbackQuery, state: FSMContext, callback_data: SirdaryoData):
