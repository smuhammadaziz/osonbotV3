...
@xorazm_yer_router.callback_query(IsGroupCall(), TasdiqlashXorazm.filter(F.word == "xorazmtasdiqlash"))
...
@xorazm_yer_router.callback_query(IsGroupCall(), BekorQilishXorazm.filter(F.word=="xorazmbekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
