...
@navoiy_yer_router.callback_query(IsGroupCall(), TasdiqlashNavoiy.filter(F.word == "navoiytasdiqlash"))
...
@navoiy_yer_router.callback_query(IsGroupCall(), BekorQilishNavoiy.filter(F.word=="navoiybekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
