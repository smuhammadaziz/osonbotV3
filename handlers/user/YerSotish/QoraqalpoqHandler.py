...
@qoraqalpoq_yer_router.callback_query(IsGroupCall(), TasdiqlashQoraqalpoq.filter(F.word == "qoraqalpoqtasdiqlash"))
...
@qoraqalpoq_yer_router.callback_query(IsGroupCall(), BekorQilishQoraqalpoq.filter(F.word=="qoraqalpoq"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
