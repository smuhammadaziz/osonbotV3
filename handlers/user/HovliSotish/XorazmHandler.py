...
@xorazm_router.message(XorazmHomeSotishHovli.images, F.media_group_id, F.content_type.in_({'photo'}))
@media_group_handler
...
@xorazm_router.callback_query(IsGroupCall(), TasdiqlashXorazm.filter(F.word == "xorazmtasdiqlash"))
...
@xorazm_router.callback_query(IsGroupCall(), BekorQilishXorazm.filter(F.word=="xorazmbekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
