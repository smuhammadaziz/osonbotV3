...
@sirdaryo_router.callback_query(IsGroupCall(), TasdiqlashSirdaryo.filter(F.word == "sirdaryotasdiqlash"))
...
@sirdaryo_router.callback_query(IsGroupCall(), BekorQilishSirdaryo.filter(F.word=="sirdaryobekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
