...
@toshvil_kv_router.callback_query(IsGroupCall(), TasdiqlashToshvil.filter(F.word == "toshviltasdiqlash"))
...
@toshvil_kv_router.callback_query(IsGroupCall(), BekorQilishToshvil.filter(F.word=="toshvilbekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
