...
@qashqa_kv_router.callback_query(IsGroupCall(), TasdiqlashQashqa.filter(F.word == "qashqatasdiqlash"))
...
@qashqa_kv_router.callback_query(IsGroupCall(), BekorQilishQashqa.filter(F.word=="qashqabekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
