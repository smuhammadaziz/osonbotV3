...
@jizzax_kv_router.callback_query(IsGroupCall(), TasdiqlashJizzax.filter(F.word == "jizzaxtasdiqlash"))
...
@jizzax_kv_router.callback_query(IsGroupCall(), BekorQilishJizzax.filter(F.word=="jizzaxbekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
