...
@andijon_kv_router.callback_query(IsGroupCall(), TasdiqlashAndijon.filter(F.word == "andijontasdiqlash"))
...
@andijon_kv_router.callback_query(IsGroupCall(), BekorQilishAndijon.filter(F.word=="andijonbekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
