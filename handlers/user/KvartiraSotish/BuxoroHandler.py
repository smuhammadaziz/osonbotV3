...
@buxoro_kv_router.message(BuxoroHomeSotish.images, F.media_group_id, F.content_type.in_({'photo'}))
@media_group_handler
...
@buxoro_kv_router.callback_query(IsGroupCall(), TasdiqlashBuxoro.filter(F.word == "buxorotasdiqlash"))
...
@buxoro_kv_router.callback_query(IsGroupCall(), BekorQilishBuxoro.filter(F.word=="buxorobekor"))
async def dokumentlar(call: types.CallbackQuery, state: FSMContext):
